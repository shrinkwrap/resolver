...
/**
 * A mapping for artifact resolved from POM file to a Map key. It is used to retrieve a version
 *
...
class ArtifactAsKey {
     ...
     * @param type Type, if empty or {@code null}, it is set to an empty string {@code jar}
     * @param classifier Classifier, if {@code null}, it is set to an empty string
     */
    ...
    public String toString() {
        return "ArtifactAsKey [artifactId=" + artifactId + ", classifier=" + classifier + ", groupId=" + groupId + ", type="
                + type + "]";
    }
