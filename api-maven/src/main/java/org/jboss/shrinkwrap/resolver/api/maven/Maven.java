...
public class Maven {
    ...
    public static GenericArchive dependency(String coordinates) throws ResolutionException {
        return DependencyResolvers.use(MavenShortcutAPIDependencyResolver.class).artifact(coordinates)
    ...
    public static Collection<GenericArchive> dependencies(String... coordinates) throws ResolutionException {
        return DependencyResolvers.use(MavenShortcutAPIDependencyResolver.class).artifacts(coordinates)
    ...
    public static MavenShortcutAPI withPom(String path) {
        return DependencyResolvers.use(MavenShortcutAPIDependencyResolver.class).withPom(path);
    }
     ...
     * @author <a href="http://community.jboss.org/people/silenius">Samuel Santos</a>
     */
    public interface MavenShortcutAPIDependencyResolver extends DependencyBuilder<MavenShortcutAPIDependencyResolver> {
         ...
         * @throws {@link IllegalArgumentException} If target archive view is not supplied
         */
        <ARCHIVEVIEW extends Assignable> ARCHIVEVIEW resolveArtifactAs(Class<ARCHIVEVIEW> archiveView)
