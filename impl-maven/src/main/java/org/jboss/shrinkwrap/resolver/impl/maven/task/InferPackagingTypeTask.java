...
/**
 * A task that returns a type of packaging appropriate for loaded pom file.
 *
...
public enum InferPackagingTypeTask implements MavenWorkingSessionTask<PackagingType> {
     ...
     */
    @Override
    public PackagingType execute(MavenWorkingSession session) {
        ...
        return session.getParsedPomFile().getPackagingType();
    }
