...
/**
 * Implementation of {@link MavenArchiveResolverSystem}
 *
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
public class MavenArchiveResolverSystemImpl
    extends
    MavenResolverSystemBaseImpl<MavenArchiveResolverSystem, ConfigurableMavenArchiveResolverSystem, PomEquippedArchiveResolveStage, PomlessArchiveResolveStage, MavenArchiveStrategyStage, MavenArchiveFormatStage>
    implements MavenArchiveResolverSystem {

    MavenArchiveResolverSystemImpl(final PomlessArchiveResolveStage delegate) {
        super(delegate);
    }
