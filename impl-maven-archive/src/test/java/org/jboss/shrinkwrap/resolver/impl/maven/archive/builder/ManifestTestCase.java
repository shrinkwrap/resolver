...
import static org.jboss.shrinkwrap.resolver.impl.maven.archive.builder.ArchiveContentMatchers.contains;
import static org.jboss.shrinkwrap.resolver.impl.maven.archive.builder.ArchiveContentMatchers.hasManifestEntry;
...
public class ManifestTestCase {
    ...
    public void manifestCreatedInJar() {
        // When
        final Archive<?> archive = ShrinkWrap.create(MavenBuilder.class).loadPomFromFile("src/it/jar-sample/pom.xml")
    ...
    public void manifestCreatedInWar() {
        // When
        final Archive<?> archive = ShrinkWrap.create(MavenBuilder.class).loadPomFromFile("src/it/war-sample/pom.xml")
    ...
    public void suppliedManifestHasPrecedence() {
        // When
        final Archive<?> archive = ShrinkWrap.create(MavenBuilder.class).loadPomFromFile("src/it/jar-with-mf-sample/pom.xml")
                .importBuildOutput().as(JavaArchive.class);
    ...
    public void manifestWithDefaultImplementationEntries() {
        // When
        final Archive<?> archive = ShrinkWrap.create(MavenBuilder.class)
