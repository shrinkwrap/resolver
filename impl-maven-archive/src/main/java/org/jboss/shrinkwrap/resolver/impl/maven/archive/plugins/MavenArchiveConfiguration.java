...
public class MavenArchiveConfiguration {
    ...
    public Manifest asManifest() throws MavenBuilderException {
    ...
    private class ManifestBuilder {
        ...
        ManifestBuilder loadFile() throws MavenBuilderException {
            if (Validate.isReadable(getManifestFile())) {
                ...
                try {
                    ...
                    throw new MavenBuilderException("Unable to build MANIFEST.MF from file "
