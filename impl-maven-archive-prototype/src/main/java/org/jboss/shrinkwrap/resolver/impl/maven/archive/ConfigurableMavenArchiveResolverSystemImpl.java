...
/**
 * {@link ConfigurableMavenArchiveResolverSystem} implementation
 *
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
public final class ConfigurableMavenArchiveResolverSystemImpl
    extends
    ConfigurableMavenResolverSystemBaseImpl<MavenArchiveResolverSystem, ConfigurableMavenArchiveResolverSystem, PomEquippedArchiveResolveStage, PomlessArchiveResolveStage, MavenArchiveStrategyStage, MavenArchiveFormatStage>
    implements ConfigurableMavenArchiveResolverSystem {

    /**
     * Creates a new instance with a new {@link MavenWorkingSession}
     *
