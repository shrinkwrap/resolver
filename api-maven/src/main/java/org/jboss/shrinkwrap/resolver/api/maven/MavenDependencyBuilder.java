...
public interface MavenDependencyBuilder extends Child<MavenDependencyResolver>,
    ...
    /**
     * Sets dependency/dependencies as optional. If dependency is marked as optional, it is always resolved, however,
     * the dependency graph can later be filtered based on {@code optional} flag
     *
     * @param optional
     *            Optional flag
