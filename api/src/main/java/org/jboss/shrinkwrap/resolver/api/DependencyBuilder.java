...
/**
 * Encapsulates access to a backing store or repository; Accepts coordinates intended to resolve to a set of
 * dependencies.
 *
...
public interface DependencyBuilder<T extends DependencyBuilder<T>> {
    /**
     * Creates an artifact builder. You can define additional parameters for the artifact later. Additional parameters
     * will be changed for all artifacts defined by this call.
     *
     * @param coordinates
    ...
    /**
     * Creates an artifact builder. You can define additional parameters for the artifacts later. Additional parameters
     * will be changed for all artifacts defined by this call.
     *
     * @param coordinates
