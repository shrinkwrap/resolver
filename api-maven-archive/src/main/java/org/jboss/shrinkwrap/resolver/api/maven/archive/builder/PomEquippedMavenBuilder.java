...
/**
 * Instance of {@link MavenBuilder} that has configuration from a POM file loaded
 *
 * @author <a href="kpiwko@redhat.com">Karel Piwko</a>
 *
 */
public interface PomEquippedMavenBuilder extends Assignable {
     ...
     * @return
     */
    PomEquippedMavenBuilder importBuildOutput();
     ...
     */
    PomEquippedMavenBuilder importBuildOutput(MavenResolutionStrategy strategy) throws IllegalArgumentException;
