...
public class ManifestTestCase {
    ...
    public void manifestCreatedInJar() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class).usingPom("src/it/jar-sample/pom.xml")
                .withBuildOutput().as(JavaArchive.class);
    ...
    public void manifestCreatedInWar() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class).usingPom("src/it/war-sample/pom.xml")
                .withBuildOutput().as(WebArchive.class);
    ...
    public void suppliedManifestHasPrecedence() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class).usingPom("src/it/jar-with-mf-sample/pom.xml")
                .withBuildOutput().as(JavaArchive.class);
    ...
    public void manifestWithDefaultImplementationEntries() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class)
                .usingPom("src/it/jar-with-mf-sample/pom-b.xml").withBuildOutput().as(JavaArchive.class);
    ...
    public void manifestWithDefaultSpecificationEntries() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class)
                .usingPom("src/it/jar-with-mf-sample/pom-c.xml").withBuildOutput().as(JavaArchive.class);
    ...
    public void manifestWithManifestSection() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class)
                .usingPom("src/it/jar-with-mf-sample/pom-d.xml").withBuildOutput().as(JavaArchive.class);
    ...
    public void manifestWithManifestSections() {
        // When
        final Archive<?> archive = ShrinkWrap.create(ArchiveMavenAssembler.class)
                .usingPom("src/it/jar-with-mf-sample/pom-e.xml").withBuildOutput().as(JavaArchive.class);
