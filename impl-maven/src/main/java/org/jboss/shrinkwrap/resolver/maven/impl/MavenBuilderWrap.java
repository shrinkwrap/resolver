...
/**
 * A wrapper which allows filters accessing internals of MavenDependencies. This
 * way interface is not polluted with getters and setters and filters can live
...
public class MavenBuilderWrap
{
    ...
    */
   public MavenBuilderWrap(MavenBuilder dependencies)
   {
      this.dependencies = (MavenBuilderImpl) dependencies;
   }
    ...
    */
   public List<MavenDependency> getDefinedDependencies()
   {
