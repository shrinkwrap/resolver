...
/**
 * Implementation of a {@link PomlessArchiveResolveStage}
 *
 * @author <a href="mailto:alr@jboss.org">Andrew Lee Rubinger</a>
 */
class PomlessArchiveResolveStageImpl
    extends
    PomlessResolveStageBaseImpl<PomEquippedArchiveResolveStage, PomlessArchiveResolveStage, MavenArchiveStrategyStage, MavenArchiveFormatStage>
    implements PomlessArchiveResolveStage {

    public PomlessArchiveResolveStageImpl(final MavenWorkingSession session) {
        super(session);
    }
     ...
     * {@inheritDoc}
     *
     * @see org.jboss.shrinkwrap.resolver.impl.maven.PomlessResolveStageBaseImpl#createNewPomEquippedResolveStage()
     */
    @Override
    protected PomEquippedArchiveResolveStage createNewPomEquippedResolveStage() {
